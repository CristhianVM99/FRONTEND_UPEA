<template>
    <div class="edu-course course-style-1 hover-button-bg-white" :class="extraClass">
        <div class="inner">
            <div class="thumbnail">
                <RouterLink to="/course/course-details">
                    <img :src="'@/static/images/course/course-type-01/' + course.image" :alt="course.alt">
                </RouterLink>
                <div class="time-top">
            ...
            <div class="content">
                ...
                <h6 class="title">
                    <RouterLink to="/course/course-details">{{ course.title }}</RouterLink>
                </h6>
        ...
        <div class="course-hover-content">
            <div class="content">
                ...
                <RouterLink to="/course/course-details" class="edu-btn btn-secondary btn-small">Enrolled <i class="icon-4"></i></RouterLink>
            </div>
        </div>
    </div>
</template>
