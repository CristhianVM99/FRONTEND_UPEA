<template>
  <div class="edu-categorie-area categorie-area-2 edu-section-gap">
    <div class="container">
      ...
      <div class="row g-5">
        <div class="col-lg-4 col-md-6" v-for="(category, index) in categories" :key="index" :data-aos-delay="50" data-aos="fade-up" data-aos-duration="800">
...
// No se necesita exportar nada en script setup
</script>
