<template>
  <div class="hero-banner hero-style-1 bg-image bg-image--11">
        ...
        <div class="col-lg-6">
          <div class="banner-content">
            ...
            <div class="banner-btn">
              <RouterLink to="/course/course-one" class="edu-btn">
        ...
        <div class="col-lg-6">
          <div class="banner-thumbnail">
            <div class="thumbnail" data-aos-delay="500" data-aos="fade-left" data-aos-duration="1000">
              <img src="@/static/images/banner/girl-1.png" alt="Girl Image">
            </div>
            <div class="instructor-info" data-aos-delay="200" data-aos="fade-up" data-aos-duration="500">
              <div class="inner">
                ...
                <div class="media">
                  <div class="thumb">
                    <img src="@/static/images/banner/author-1.png" alt="Images">
                  </div>
                  <div class="content">
            ...
            <ul class="shape-group">
              <li class="shape-1" data-aos-delay="1000" data-aos="fade" data-aos-duration="1000">
                <img src="@/static/images/about/shape-15.png" alt="Shape">
              </li>

              <li class="shape-4" data-aos-delay="1000" data-aos="fade" data-aos-duration="1000">
                <img src="@/static/images/counterup/shape-02.png" alt="Shape">
              </li>
    ...
    <div class="shape-7">
      <img src="@/static/images/about/h-1-shape-01.png" alt="Shape">
    </div>
  </div>
</template>
